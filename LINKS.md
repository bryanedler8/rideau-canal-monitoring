...
- **URL:** https://github.com/bryanedler8/rideau-canal-sensor-simulation
- **Description:** IoT sensor simulator code

### 3. Web Dashboard Repository
- **URL:** https://github.com/bryanedler8/rideau-canal-dashboard
- **Description:** Web dashboard application

## Demo

- **Video Demo:** [YouTube](https://youtu.be/PVevXKXoxew)
